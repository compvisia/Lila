...
namespace Lila {
	...
	FrameBuffer::FrameBuffer(FrameSpecs spec) {
		m_spec = spec;
		Create();
	}
	...
	void FrameBuffer::Create() {
		...
		glTexImage2D(GL_TEXTURE_2D, 0, GL_DEPTH24_STENCIL8, m_spec.width, m_spec.height, 0, GL_DEPTH_STENCIL, GL_UNSIGNED_INT_24_8, 0);
